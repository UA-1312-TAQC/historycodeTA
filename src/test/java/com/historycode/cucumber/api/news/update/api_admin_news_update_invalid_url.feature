Feature: Admin cannot update news with an invalid 'url' containing capital letters using PUT method

  Scenario: Verify that 'url' field does not accept capital letters when updating news
