...
@Getter
public class CreateNewsTitleRequired extends BaseStep {
    ...
    private final String newsText = "Only the brave have happiness";
    ...
    */
    ...
    @And("Create the {string} to {string}")
    public void fillNewsDetails() {
        createEditNewsModal.inputNewsTitle(null);
