...
public class AdminMenuBarComponent extends BaseComponent {
    ...
    @FindBy(xpath = ".//a[@href='/admin-panel']")
    WebElement streetCodes;
    @FindBy(xpath = ".//a[@href='/admin-panel/partners']")
    WebElement partners;
    @FindBy(xpath = ".//a[@href='/admin-panel/editor']")
    WebElement editor;
    @FindBy(xpath = ".//a[@href='/admin-panel/team']")
    WebElement team;
    @FindBy(xpath = ".//a[@href='/admin-panel/news']")
    WebElement news;
    @FindBy(xpath = ".//a[@href='/admin-panel/job']")
    WebElement jobs;
